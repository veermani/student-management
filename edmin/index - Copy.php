    ...
    ?>
     ...
     <!-- <button href="task.php?" id="" class="k"> -->
        ...
        <!-- </a> -->
                            ...
                            <ul class="widget widget-menu unstyled">
                                <li><a href="ui-button-icon.php"><i class="menu-icon icon-bold"></i> Chat </a></li>
                                <li><a href="ui-typography.html"><i class="menu-icon icon-book"></i>Typography </a></li>
                                <li><a href="form.php"><i class="menu-icon icon-paste"></i>Application</a></li>
                                ...
                                <td width="56%">
                                    ...
                                    <table width="100%" class="table" border="0" style="margin-left:13px; margin-top:17px">
                                        ...
                                        <tr class="trr2">
                                            ...
                                            <td>
                                                <label id="MCPH1_SCPH_lblMon"><?php echo $row['Monthly_income']?></label>
                                            </td>
                                        </tr>
                                        <tr class="trr1">
                                            <td>
